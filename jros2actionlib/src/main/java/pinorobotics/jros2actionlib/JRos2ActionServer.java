 ...
 */
public class JRos2ActionServer<G extends Message, R extends Message> extends IdempotentService {

    private static final XLogger LOGGER = XLogger.getLogger(JRos2ActionServer.class);
