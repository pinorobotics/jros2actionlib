...
/**
 * Action Feedback functionality is not supported by the <b>jros2actionlib</b> at this moment. This
 * class is just a stub temporary implementation.
 *
 * @author aeon_flux aeon_flux@eclipso.ch
 */
@MessageMetadata(
        name = Action2FeedbackMessage.NAME,
        fields = {"goal_id", "stamp"},
        interfaceType = RosInterfaceType.ACTION)
public class Action2FeedbackMessage implements Message {
    ...
    public Action2FeedbackMessage withGoalId(Action2GoalIdMessage goal_id) {
        this.goal_id = goal_id;
        return this;
    }

    public Action2FeedbackMessage withTimestamp(Time time) {
        this.stamp = time;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        var other = (Action2FeedbackMessage) obj;
