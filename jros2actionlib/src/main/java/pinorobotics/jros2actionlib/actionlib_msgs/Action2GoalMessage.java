...
/**
 * ROS2: This class represents the Send Goal requests which usually defined in
 ...
 */
public interface Action2GoalMessage<G extends Message>
        extends ActionGoalMessage<Action2GoalIdMessage, G> {}
